...
func (fakeRuntime) RestartContainer(context.Context, string, time.Duration) error      { return nil }
func (fakeRuntime) ListAllContainers(context.Context) ([]runtime.ContainerInfo, error) {
	return nil, nil
}
